...
export function Footer({ links = _DEFAULT_LINKS }: Props) {
  return (
    <footer className="oj-web-applayout-footer" role="contentinfo">
      <div className="oj-web-applayout-footer-item oj-web-applayout-max-width">
        <ul>
          {links.map((item) => (
            <li>
      ...
      <div className="oj-web-applayout-footer-item oj-web-applayout-max-width oj-text-color-secondary oj-typography-body-sm">
